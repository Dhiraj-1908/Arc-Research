// Research constants
export const MAX_ITERATIONS = 4; // Maximum number of iterations
export const MAX_SEARCH_RESULTS = 4; // Maximum number of search results
export const MAX_CONTENT_CHARS = 45000; // Maximum number of characters in the content
